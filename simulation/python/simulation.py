...
def simulation(filename):
    ...
    # Apply gaussian filter to the img
    img = cv2.GaussianBlur(img, (3, 3), 0)

    # for i in range(0, img.shape[1], grid_sz):
    #     cv2.line(img, (i, 0), (i, img.shape[0]), (0, 255, 0), 1)
    cv2.line(img, (125, 275), (325, 275), (0, 255, 0), 1)
    cv2.line(img, (125, 375), (325, 375), (0, 255, 0), 1)
    for i in range(125, 301, 25):
        cv2.line(img, (i, 275), (i, 375), (0, 255, 0), 1)
    cv2.line(img, (125, 375), (125, 275), (0, 255, 0), 1)
    cv2.line(img, (325, 275), (325, 375), (0, 255, 0), 1)
    for i in range(275, 376, 25):
        cv2.line(img, (125, i), (325, i), (0, 255, 0), 1)

    # Draw the robot and the goal
    cv2.rectangle(img, (35, 240), (55, 260), (0, 255, 128), -1)
    cv2.circle(img, (450, 425), 6, (0, 0, 255), -1)
    cv2.circle(img, (150, 300), 2, (0, 255, 128), 1)
    # cv2.imwrite("APF_sim_python.png",img.astype('uint8'))
    cv2.imshow('Map SAPF', img)
