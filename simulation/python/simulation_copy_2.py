...
def simulation(filename):
    ...
    cv2.line(img, (215,230), (215,250), (0, 0, 255), 2)
    cv2.line(img, (235,250), (215,250), (0, 0, 255), 2)
    cv2.line(img, (235,250), (235,230), (0, 0, 255), 2)
    cv2.line(img, (215,230), (235,230), (0, 0, 255), 2)
    ...
    cv2.line(img, (225,230), (225,250), (0, 0, 255), 1)
    cv2.line(img, (235,240), (215,240), (0, 0, 255), 1)
    # cv2.line(img, (200,250), (200,230), (0, 0, 255), 1)
    # cv2.line(img, (180,230), (200,230), (0, 0, 255), 1)
